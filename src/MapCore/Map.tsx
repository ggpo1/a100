...
export default class Map extends React.PureComponent<IMapProps, IMapState> {
    ...
    constructor(props: IMapProps) {
        ...
        Emit.Emitter.addListener('setSelectedVik', (vik: VikItem, stillage: StillageItem) => this.setState({
            selectedVik: vik,
    ...
    private wallLabelButtonInteractionWayDown(e, wallSource: WallItem, isStart: boolean) {
        ...
        this.setState({
            resizingWallIndex: found.index,
            isStart,
            selectedWallToResize: wallSource,
            isWallResizingNow: true,
            isDrawing: true
        });
    }
